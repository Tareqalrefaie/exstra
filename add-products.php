...
if (isset($_POST['update_product'])) {
   ...
   '$update_name', price = '$update_price' WHERE id = '$update_p_id'") ;
         ...
         if (mysqli_num_rows($select_products) > 0) {
            while ($fetch_products = mysqli_fetch_assoc($select_products)) {
               ...
               <div class="box">
                  ...
                  <div class="buttons">
                     <a href="add-products.php?update=
         <?php echo $fetch_products['id']; ?>" class="option-btn">Update</a>

                     <a href="add-products.php?delete=
         <?php echo $fetch_products['id']; ?>" class="delete-btn"
