...
<body>
   ...
   <section class="shopping-cart">
         ...
         if (mysqli_num_rows($select_cart) > 0) {
            while ($fetch_cart = mysqli_fetch_assoc($select_cart)) {
               ...
               <div class="box">
                  ...
                  <img style="width:100%" src="uploaded_img/<?php echo $fetch_cart['image']; ?>" alt="">
                  <div class="name"><?php echo $fetch_cart['name']; ?></div>
                  <div class="price"><?php echo $fetch_cart['price']; ?> JD</div>
                  ...
                  <div class="sub-total"> Sub Total :
                     <span>JD<?php echo $sub_total = ($fetch_cart['quantity'] * $fetch_cart['price']); ?></span> </div>
               </div>
               <?php
      ...
      <div class="cart-total">
         <p>Grand Total : <span><?php echo $grand_total; ?> JD</span></p>
         <div class="flex">
